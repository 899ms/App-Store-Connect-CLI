...
<ParamField path="--version" type="string">
  ...
  newest active editable App Store version (`PREPARE_FOR_SUBMISSION`,
  ...
  continuations, which already carry their version. This flag accepts an App
  Store version ID, not the display version string.
</ParamField>
