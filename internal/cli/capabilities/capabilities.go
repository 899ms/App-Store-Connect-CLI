...
func capabilityRows() []Capability {
	return []Capability{
		...
		},
		{
			...
			NextAction: "Use list and view to inspect existing keys, then create with --name, --bundle-id, --output-dir, and --confirm, or recover a download with --key-id and --output-dir.",
		},
		{
			Area:         "signing",
